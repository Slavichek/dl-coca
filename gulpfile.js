...
function jsLibs() {
    src([
        "#src/libs/fullpage.js/dist/fullpage.js",
...
function cssLibs() {
    src([
        "#src/libs/fullpage.js/dist/fullpage.css",
        "#src/libs/jquery-selectric/public/selectric.css",
...
let build = gulp.series(
    clean,
    gulp.parallel(js, css, html, images, jsLibs, cssLibs)
);
...
// gulp otf2ttf (task fonts) not need in this project
// gulp (start project)
